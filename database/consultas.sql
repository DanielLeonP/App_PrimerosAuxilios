...
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Paro Cardiaco',1,'Los síntomas del paro cardíaco repentino son inmediatos y drásticos, entre ellos: colapso súbito, falta de pulso, falta de respiración, pérdida del conocimiento.','https://youtu.be/dtn5yAKqeXU');
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Ataque al Corazón / Infarto',2,'Dolor persistente, malestar o presión, constante o paulatina sobre el centro del pecho o sus alrededores, que dura de 3 a 5 minutos, después de este tiempo, la persona empieza a dejar de responder físicamente. Dificultad para respirar, palidez, mareos.','https://youtu.be/gNYKOuZhoBk');
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Ataque Convulsivo / Convulsión',3,'Rigidez en el cuerpo y movimientos involuntarios y espasmódicos, babeo o generación de espuma por la boca, gruñidos, movimientos rápidos de los ojos, inclusive perdida de control de su cuerpo.','https://youtu.be/sIlfgtHpf-0');
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Atragantamiento / Asfixia',4,'Obstrucción de las vías respiratorias, ambiente tóxico y/o falta de oxígeno, función pulmonar deficiente, traumatismos torácicos, lesiones cerebrales.','https://youtu.be/vBvMbXjCA14?t=25');
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Choque Eléctrico / Electrocución',5,'Quemaduras, dolor constante o palpitante en todo el cuerpo, incapacidad de moverse o responder a cualquier acción, la persona puede estar inconsciente, desmayo, hormigueo, ataques espasmódicos.','https://youtu.be/cdEGIBokVXU');
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Cortaduras / Hemorragias',6,'Dolor, hipersensibilidad, equimosis e hinchazón, son signos que pueden significar que una fractura cerrada está sangrando, fracturas costales, equimosis sobre la parte inferior del tórax o un abdomen rígido, distendido, son signos y síntomas que pueden indicar un bazo o hígado lacerado, en general, desangrado paulatino o constante.','https://youtu.be/k0lWfBm1w2I');
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Ataque de Asma',7,'Dificultad para respirar, pulso acelerado, sensación de opresión en el pecho, ansiedad.','https://youtu.be/Y_eNCrEEQ7M');
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Reacciones Alérgicas',8,'Ardor y comezón en los ojos y/o nariz, salpullido, estornudos, tos, náuseas, nariz congestionada, diarrea, dificultad para respirar, garganta cerrada.','https://youtu.be/W6WPWuIdaEo');
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Intoxicación / Envenenamiento',9,'Malestar, dolor de cabeza, mareos, náuseas o vómitos. Ardor y/o dolor de garganta, tos repentina, dificultad para tragar o respirar, babeo, falta de fuerzas, somnolencia repentina, confusión o disminución de la capacidad mental, convulsiones, desvanecimiento, ronchas repentinas, inflamación, cambio de color de la piel, de los labios, debilidad, irritabilidad, vértigo, fiebre.','https://youtu.be/fQC6yHfCkYQ');
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Fracturas Importantes',10,'Dolor intenso, extremidad que se ve fuera de lugar, hinchazón, hematomas o dolor alrededor de la herida, problemas al mover la extremidad, huesos salidos o rotos, sonidos rasposos al mover la extremidad.','https://youtu.be/IxFpbOI971Q');
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Golpe de Calor / Deshidratación',11,'Labios secos, dolor de cabeza, adormecimiento, calambres, mucha sed, piel seca, arrugada y ausencia de sudoración.','https://youtu.be/2DiU6VPlAbM');
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Hipotermia',12,'Escalofríos, hablar arrastrando las palabras o balbuceo, respiración lenta y superficial, pulso débil, torpeza o falta de coordinación, somnolencia o muy poca energía, desorientación o pérdida de memoria, pérdida del conocimiento y piel de color rojo brillante y fría (en bebés).','https://youtu.be/GRUREDhFsgo');
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Quemaduras Importantes',13,'Enrojecimiento de la piel, dolor constante, hinchazón, ampollas, destrucción extensa de la piel, irritación, aparición de costras, inflamación.','https://youtu.be/iqn1Lb8kcqg');
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Mordedura / Picaduras',14,'Enrojecimiento de la zona, dolor local intenso. Son más dolorosas que peligrosas, piel caliente, picor, inflamación y posterior edema, malestar general, náuseas, cefaleas, en casos graves.','https://youtu.be/AEHDznHGjlw');
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Esguinces',15,'Dolor intenso en la articulación, hinchazón en la zona afectada, imposibilidad de movimiento de la zona afectada.','https://youtu.be/hfIQz9FaDls');
INSERT INTO emergencia(nombre,prioridad,sintomas,video) VALUES ('Calambres',16,'Dolor intenso y localizado en un músculo, sensación de tener el músculo duro, palpitación y tensión muscular.','https://youtu.be/_RYPtEz1atU');
